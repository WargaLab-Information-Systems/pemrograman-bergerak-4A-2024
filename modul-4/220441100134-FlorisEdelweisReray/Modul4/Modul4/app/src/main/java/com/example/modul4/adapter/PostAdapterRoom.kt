...
class PostAdapterRoom (private var postList: List<PostEntity>) :
    ...
    class PeopleViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val playerDescription: MaterialTextView = itemView.findViewById(R.id.descpost)
        val playerImage: ShapeableImageView = itemView.findViewById(R.id.imgpost)
    ...
    override fun onBindViewHolder(holder: PeopleViewHolder, position: Int) {
        ...
        holder.loveImageView.setOnClickListener {
            if (!isLiked) {
                ...
                holder.loveImageView.setImageResource(R.drawable.like2) // mengubah sumber daya ImageView menjadi versi merah
                isLiked = true // Setelah tombol "like" ditekan, tandai bahwa sudah ditekan
            } else {
                like++
                holder.likeTextView.text = like.toString()
                holder.loveImageView.setImageResource(R.drawable.like) // mengubah sumber daya ImageView menjadi versi putih
