...
class PostAdapterRoom (private var postList: List<PostEntity>) :
    ...
    class PeopleViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val playerName: MaterialTextView = itemView.findViewById(R.id.judul)
        val playerDescription: MaterialTextView = itemView.findViewById(R.id.caption)
        val playerImage: ShapeableImageView = itemView.findViewById(R.id.image)
        val loveImageView: ImageView = itemView.findViewById(R.id.like)
        val likeTextView: TextView = itemView.findViewById(R.id.like2)
    }
    ...
    override fun onBindViewHolder(holder: PeopleViewHolder, position: Int) {
        ...
        holder.loveImageView.setOnClickListener {
            if (!isLiked) {
                ...
                holder.loveImageView.setImageResource(R.drawable.ic_like2) // mengubah sumber daya ImageView menjadi versi merah
                isLiked = true // Setelah tombol "like" ditekan, tandai bahwa sudah ditekan
            } else {
                like++
                holder.likeTextView.text = like.toString()
                holder.loveImageView.setImageResource(R.drawable.ic_like) // mengubah sumber daya ImageView menjadi versi putih
