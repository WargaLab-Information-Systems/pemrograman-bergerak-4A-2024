...
class New_Post : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        playerImage = findViewById(R.id.posting)
        playerName = findViewById(R.id.postjudul)
        playerDescription = findViewById(R.id.postdesc)
        playerImageInput = findViewById(R.id.buttonChange)
    ...
    private fun onClick() {
        ...
        val openImagePicker = findViewById<Button>(R.id.buttonChange)
        ...
        val btnUpPost = findViewById<Button>(R.id.up_post)
        btnUpPost.setOnClickListener {
