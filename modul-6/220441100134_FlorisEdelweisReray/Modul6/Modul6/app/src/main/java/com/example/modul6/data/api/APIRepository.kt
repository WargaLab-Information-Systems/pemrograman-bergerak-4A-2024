...
class APIRepository {
    ...
    private val _listPlayer = MutableLiveData<List<mediaData>>()
    // Mendeklarasikan variabel listPlayer sebagai LiveData yang berisi List dari ExampleAPIResponse
    var listPlayer: LiveData<List<mediaData>> = _listPlayer
    ...
    private val _player = MutableLiveData<mediaData>()
    // Mendeklarasikan variabel player sebagai LiveData yang berisi ExampleAPIResponse
    var player: LiveData<mediaData> = _player
