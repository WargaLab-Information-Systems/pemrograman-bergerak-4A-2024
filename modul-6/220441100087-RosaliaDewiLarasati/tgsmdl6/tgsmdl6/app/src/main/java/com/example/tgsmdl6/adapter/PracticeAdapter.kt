package com.example.tgsmdl6.adapter
//pAdapter sama dengan sebelumnya isinya recyclerView diambil dari list player.
// untuk background card di ambil dari data yang ada di API
...
import com.example.tgsmdl6.R
import com.example.tgsmdl6.data.Player
