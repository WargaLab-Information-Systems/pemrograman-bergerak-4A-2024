package com.example.a039bunga_modul6.adapter
...
import com.example.a039bunga_modul6.R
...
class playerAdapter (private var player: List<playerData>) : RecyclerView.Adapter<playerAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val playerName: TextView = itemView.findViewById(R.id.namapemain)
        val playerPosition: TextView = itemView.findViewById(R.id.posisi)
        val playerGa: TextView = itemView.findViewById(R.id.gapemain)
        val playerNumber: TextView = itemView.findViewById(R.id.nomor)
        ...
        val background: ConstraintLayout = itemView.findViewById(R.id.bg)
    }
