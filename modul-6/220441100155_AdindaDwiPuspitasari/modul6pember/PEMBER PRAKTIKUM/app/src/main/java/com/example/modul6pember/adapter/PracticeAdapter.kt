...
// berisi recyclerview adapter di ambil dr list player, data2 yg di player
class PracticeAdapter (private var players: List<Player>) :
    ...
    // ini untuk ke activity sesuai dengan id id nya
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(holder.backgroundImage.context)
            .load(data.background_card) // di ambil dari data dari API
