...
import com.example.modul6pember.adapter.PracticeAdapter
import com.example.modul6pember.data.Player
import com.example.modul6pember.data.PracticeViewModel
import com.example.modul6pember.data.PracticeViewModelFactory
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ini untuk menampilkan dari practice view model
        ...
        // variabel ini untuk klik profile, dan akan masuk ke class AboutCreatorActivity
