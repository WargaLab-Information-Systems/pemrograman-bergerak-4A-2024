...
//untuk menampilkan ke recyclerview yang horizontal
...
class PlayerAdaptor (private val playerList: List<PlayerData>) : RecyclerView.Adapter<PlayerAdaptor.PlayerViewHolder>() {
    ...
    class PlayerViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        //val playerDescription: TextView = itemView.findViewById(R.id.player_description)
        val playerImage: ShapeableImageView = itemView.findViewById(R.id.player_image)
        val playerTempat: TextView = itemView.findViewById(R.id.player_tempat)
    }
    ...
    override fun onCreateViewHolder(
        ...
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.itemplayer, parent, false)
    ...
    override fun onBindViewHolder(holder: PlayerViewHolder, position: Int) {
        ...
        holder.playerTempat.text = data.tempat.shorten(50)
        //holder.playerDescription.text = data.description.shorten(50)
