...
class Add_People_Room : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //mengambil id yang ada di activity
    ...
    private fun savedData() {
        ...
        // Membuat objek pemain dengan data yang diinputkan sesuai dengan kolom yang ada di database
