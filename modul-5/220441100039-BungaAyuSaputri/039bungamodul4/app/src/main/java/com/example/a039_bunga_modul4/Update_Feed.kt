...
class Update_Feed : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        updateImg = findViewById(R.id.postimg)
        updatetitle = findViewById(R.id.upjudul)
        updatedesc = findViewById(R.id.updesc)
        bImg = findViewById(R.id.tblUbah)
    ...
    private fun onClick() {
        val openImagePicker = findViewById<Button>(R.id.tblUbah)
        ...
        val bUpdate = findViewById<Button>(R.id.tblupdate)
