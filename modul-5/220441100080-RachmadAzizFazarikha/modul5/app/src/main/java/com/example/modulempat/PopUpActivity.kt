...
class PopUpActivity(private val kntnDatabase: kontenDatabase, position: Int) : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnUbah.setOnClickListener {
            val intent = Intent(requireContext(), UpdateKontenActivity::class.java)
